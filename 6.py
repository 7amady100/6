...
print(timee)
print('  ')
hunter = pyfiglet.figlet_format(" SANTITO ")
print(' ')
def j(z):
    for e in z:
        sys.stdout.write(e)
        sys.stdout.flush()
        time.sleep(290/10000)
j(Y+hunter)
j('¯'*25)
os.system("clear") 
print('   ') 
...
timee=time.asctime()
print(timee)
hunter1 = pyfiglet.figlet_format(" INSTGRAM  ")
print(' ')
def j(z):
    for e in z:
        sys.stdout.write(e)
...
def code_mrko(userQ,password):
	...
	shugpro    = str(req_id['graphql']['user']['is_verified']) 
